...
<head>
    ...
    <link rel="stylesheet" href="node_modules/qcfirst/signUpStyle.css">
</head>
<body>
<div>
...
<form class="main-form" action="node_modules/qcfirst/signUp.inc.php" method="post" id="registerForm">
    <div class="container">
